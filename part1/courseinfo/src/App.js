...
const Total = (props) => {
  return (
    <div>Total number of exercises: {props.course.parts[0].exercises + props.course.parts[1].exercises + props.course.parts[2].exercises}</div>
  )
}

const Part = (props) => {
  return (
    <p>{props.part}: {props.ex} exercises</p>
  )
}
